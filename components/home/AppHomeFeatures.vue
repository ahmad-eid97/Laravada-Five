      ...
      <div class="col-6 p-0">
        <div class="feature-1">
          <div class="feature-inner">
            ...
            <div class="seprator">
              <img
                src="https://avada.theme-fusion.com/financial-advisor/wp-content/uploads/sites/145/2020/08/slant-separator.png"
                alt=""
              />
            </div>
            <p>
          ...
          <div class="feature-shape">
            <div class="row mx-0">
              <div class="col image p-0">
                <img
                  src="https://avada.theme-fusion.com/financial-advisor/wp-content/uploads/sites/145/2020/08/testimonial-image.jpg"
                  alt=""
                />
              </div>
              <div class="col text p-0">
                <div class="text-inner">
                  ...
                  <p>
                    <em>
                      Going from clueless with money to being savvy enough to
                      invest in my future and live well within my means in what
                      feels like an instant after talking to Avada Financial
                      Consultants has really put my mind at rest and I can now
                      make informed,educated smart decisions with my money.
                    </em>
                  </p>
                  <p>
                    <a href="#">
              ...
              >
                <b-card-body>
                  <p>
                    ...
                    Phasellus vulputate blandit egestas. Vestibulum ante ipsum
...
.features .feature-1 .feature-inner {
  padding-bottom: 0px;
  padding-left: 106px;
  padding-right: 0px;
  padding-top: 0px;
...
.features .seprator img {
  width: 70px;
  margin-top: 5px;
  margin-bottom: 20px;
}
.features .feature-inner p {
  margin-top: 0;
  margin-bottom: 20px;
  color: rgb(74, 78, 87);
  font-size: 16px;
...
.features .feature-1 .feature-shape {
  margin-top: 120px;
}
.features .feature-1 .feature-shape .image {
  margin-left: 10px;
  margin-right: 10px;
  overflow: hidden;
}
.features .feature-1 .feature-shape .image img {
  width: 231px;
  max-width: 100%;
  border-radius: 40px;
}
.features .feature-1 .feature-shape .text {
  margin-top: 100px;
  margin-bottom: -30px;
  width: 250px;
}
.features .feature-1 .feature-shape .text .text-inner {
  ...
  margin-left: -80px;
  box-shadow: rgba(0, 0, 0, 0.12) 0px 20px 33px 0px;
}
.features .feature-1 .feature-shape .text .text-inner p {
  font-size: 14px;
  font-weight: 700;
  line-height: 25.2px;
  color: rgb(33, 41, 52);
...
.features .feature-1 .feature-shape .text .text-inner a {
  font-size: 14px;
  font-weight: 700;
  line-height: 25.2px;
  color: rgb(33, 41, 52);
